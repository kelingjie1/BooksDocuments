...
public:
    ...
    virtual void setup() {
        Example::setup();
        program = ExampleUtil::instance()->createProgram("ExampleTextureAnimation.vs", "ExampleTextureAnimation.fs");
        ...
        texture = ExampleUtil::instance()->createTexture(QImage(":/star.png"));
